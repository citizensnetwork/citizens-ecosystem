...
function FlagIcon({ className = "" }: { className?: string }) {
  // Yellow warning triangle with exclamation — reads more clearly as "report
  // concern" than the older outline flag, especially at the icon-button
  // variant's 16×16 size. Stroke colour is currentColor so parents can still
  // tint it via Tailwind; inner fill is always the gold-amber warning tone.
  return (
    <svg
      viewBox="0 0 24 24"
      className={className}
