...
The Christian community operates in silos. Ministries, churches, NGOs, brands, outreaches, home groups, markets, and initiatives work in isolation — often duplicating effort, going unseen, and producing limited results. There is no shared infrastructure connecting these entities or making their work discoverable.

## The Mission

**Restoring Kingdom unity, visibility, and collaboration through infrastructure that serves the community.**
...
The name "Citizens" is a direct reference to this passage — we are citizens of the same Kingdom, each contributing our own part.

## Core Principles

1. **Visibility over obscurity** — Every initiative, no matter how small, deserves to be seen
2. **Collaboration over competition** — Similar ministries should find and strengthen each other, not duplicate in isolation
...
## The Citizens Ecosystem

Citizens is the parent brand. Each "channel" serves a specific dimension of Kingdom life:
...
**Serves:** Anyone looking to find churches, ministries, NGOs, home groups, outreaches, and organizations across any area
**Core experience:** Searchable index of all Christian entities with social collaboration tools for joint event planning

### Citizens Impact (Future)
**What:** Collaborative social impact and project organizing platform
**Serves:** Businesses, financial institutions, and larger organizations looking to impact their communities through structured giving, volunteering, and project management
**Core experience:** Create, fund, and collaborate on community impact projects

### Future Channels
Additional channels will emerge as the ecosystem grows. Later stages may include business and government integration.

## What Citizens Connect Must Embody

As the first and flagship channel, Connect sets the standard for the entire ecosystem:

- **Community-first content identity** — The distinctive value of Connect is surfacing the incredibly vibrant and diverse layer of community activity that currently goes unseen: outreaches, creative events, social gatherings, celebrations, educational sessions, healing retreats, community projects, markets, and more. Churches and church services are absolutely present and valued, but they are not the only content — the hero of the platform is the rich, full tapestry of Kingdom initiatives that would otherwise remain invisible. When a user opens Connect, they should be struck by the colour and variety of community life, not a list of Sunday services.
...
When assessing any proposed feature, ask:

1. **Does it increase visibility** of existing Kingdom work?
2. **Does it connect** entities that would otherwise remain siloed?
3. **Does it highlight entity value** — making every participant feel their role matters?
...
Connect's map and calendar should feel alive with the diversity of Kingdom activity. The content mix should reflect the full breadth of what happens in the Kingdom — outreaches, creative events, social gatherings, celebrations, workshops, healing retreats, youth programmes, markets, educational sessions, community projects, church services, prayer meetings, and more. Churches are valued and included, but they are one voice among many. The hero is the entire tapestry — the colour and variety of Kingdom life that, until now, has gone unseen.

## Target Entities (Connect)

Current: Events, places (churches, ministries, venues)
Expanding to: Organizations, home groups, outreaches, markets, brands, community projects
Future integration: Businesses, government initiatives

## Growth Philosophy

Growth comes from utility — people share because events are easy to find and share, not because of marketing. Privacy and transparency are paramount in a faith community.
